...
<style scoped>
.social-share__btn {
  @apply inline-flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-700 transition hover:border-amber-400 hover:text-amber-700 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:border-amber-500 dark:hover:text-amber-400;
}
