...
<style scoped>
.auth-input {
  @apply w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-gray-900 outline-none ring-amber-500 focus:border-amber-500 focus:ring-2 dark:border-gray-600 dark:bg-gray-900 dark:text-white;
}
</style>
