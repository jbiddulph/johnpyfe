<template>
  <section
    v-if="showBanner"
    class="world-cup-banner border-b border-primary-700/30 bg-gradient-to-r from-green-900 via-gray-900 to-red-900"
    aria-label="Argentina vs Spain World Cup Final"
  >
    <div class="container mx-auto px-4 py-8 md:py-10">
      <div class="text-center">
        <p class="mb-2 text-xs font-semibold uppercase tracking-[0.2em] text-pint">
