<template>
  <section
    v-if="showBanner"
    class="world-cup-banner border-b border-blue-700/30 bg-gradient-to-r from-green-900 via-gray-900 to-red-900"
  ...
  >
    <div class="container mx-auto px-4 py-8 md:py-10">
        ...
        <div class="mb-4 flex items-center justify-center gap-4 md:gap-8" role="group" aria-label="Argentina vs Spain">
          ...
          <div class="flex flex-col items-center">
            ...
            <time
              ...
              class="mt-1 text-sm font-medium text-blue-200 md:text-base"
            >
      ...
      <section class="mt-8 rounded-lg border border-white/10 bg-black/20">
        <h3 class="px-4 py-3 text-sm font-semibold text-blue-200 md:text-base">
