            ...
            >
              <span class="block truncate font-medium text-gray-900 dark:text-white">
                ...
                <span
                  ...
                  class="ml-1 text-[10px] font-semibold uppercase tracking-wide text-blue-700"
                >Yours</span>
                <span
                  v-else
      ...
      >
        ...
        <div class="space-y-2">
          ...
          <input
            ...
            type="datetime-local"
            class="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white"
          />
            ...
            >
              ...
              <li
                ...
                :class="index === highlightIndex
                  ? 'bg-blue-50 text-blue-950 dark:bg-blue-950/50 dark:text-blue-50'
          ...
          <ol v-else class="m-0 list-none space-y-0 p-0">
            <template v-for="(stop, index) in stops" :key="stop.id || `draft-${index}`">
              <li
                ...
                :class="{
                  'border-blue-400 ring-1 ring-blue-400': dragIndex === index,
                  'border-blue-300': dropIndex === index && dragIndex !== index,
                ...
                <div class="flex items-start gap-2 px-2 py-2">
                  ...
                  <div class="min-w-0 flex-1">
                    <div class="flex flex-wrap items-center gap-2">
                      <span
                        class="inline-flex h-6 min-w-[1.5rem] items-center justify-center rounded bg-blue-100 px-1.5 text-xs font-semibold text-blue-900 dark:bg-blue-900 dark:text-blue-100"
                      >
                        {{ index + 1 }}
                      </span>
                      <span
                    ...
                    <p v-else-if="!stop.venueId" class="text-xs text-blue-700 dark:text-blue-400">
              ...
              >
                <UIcon name="i-heroicons-arrow-long-down-20-solid" class="h-4 w-4 shrink-0 text-blue-600" />
