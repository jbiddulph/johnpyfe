    ...
    <div class="w-full">
      ...
      <div class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
        <div class="container mx-auto px-4 py-5">
          <p v-if="event.category?.name" class="text-sm font-medium uppercase tracking-wide text-primary-600 dark:text-primary-500 mb-1">
            {{ event.category.name }}
          </p>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-6">
        ...
        <aside class="space-y-4">
          <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-900">
            ...
            <dl class="space-y-4 text-gray-700 dark:text-gray-300">
              ...
              <div v-if="event.website">
                ...
                <dd class="text-lg mt-1">
                  <a :href="event.website" target="_blank" rel="noopener" class="text-primary-600 hover:underline break-all dark:text-primary-500">
                    View event page
                  </a>
                </dd>
              </div>
          ...
          <NuxtLink
            v-if="event.listing"
            :to="venuePath(event.listing.id, event.listing.slug)"
            class="block rounded-lg border border-primary-200 bg-primary-50 px-4 py-3 text-center font-semibold text-primary-800 hover:bg-primary-100 dark:border-primary-900 dark:bg-primary-950 dark:text-primary-200 dark:hover:bg-primary-900"
          >
