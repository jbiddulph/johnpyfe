  ...
  <div class="mx-auto max-w-5xl px-4 py-8">
    <div class="mb-6 flex flex-wrap items-start justify-between gap-3">
      ...
      <div class="flex flex-wrap gap-2">
        <UButton color="blue" to="/map" label="Open map builder" />
    ...
    <template v-else>
      ...
      <section v-if="pendingInvites.length" class="mb-8 space-y-3">
        <div class="rounded-lg border border-blue-300 bg-blue-50 px-4 py-3 dark:border-blue-800 dark:bg-blue-950/40">
        ...
        <UCard
          ...
          :key="invite.id"
          :ui="{ body: { padding: 'p-4' }, ring: 'ring-1 ring-blue-300 dark:ring-blue-800' }"
        >
          <div class="flex flex-wrap items-center justify-between gap-3">
            <div class="min-w-0 space-y-1">
              ...
              <p v-if="invite.startsAt" class="text-sm font-medium text-blue-950 dark:text-blue-100">
                Starts {{ formatCrawlStartsAt(invite.startsAt) }}
              </p>
              <p
                v-if="invite.inviteeNotes"
                class="whitespace-pre-wrap text-sm text-blue-900/90 dark:text-blue-100/90"
              >
                {{ invite.inviteeNotes }}
              </p>
            </div>
      ...
      <section v-if="unreadNotifications.length" class="mb-8 space-y-2">
        <div class="flex items-center justify-between gap-2">
          <h2 class="text-sm font-semibold uppercase tracking-wide text-gray-500">
            Notifications
            <span class="ml-1 rounded bg-blue-100 px-1.5 py-0.5 text-blue-900">
        ...
        <ul class="space-y-2">
          <li
            ...
            :key="note.id"
            class="rounded-md border border-blue-300 bg-blue-50 px-3 py-2 text-sm dark:border-blue-800 dark:bg-blue-950/40"
          >
      ...
      <section class="mb-8 space-y-3">
        ...
        <p v-else class="text-sm text-gray-500">
          ...
          <NuxtLink to="/map" class="text-blue-700 hover:underline">Create one on the map</NuxtLink>
        </p>
      </section>
