    ...
    <div class="pb-12">
      ...
      <p v-if="!loadError && (activeSearch || selectedTown || selectedCounty || totalItems > 0)" class="text-center text-sm text-gray-600 mb-4">
        <template v-if="activeSearch || selectedTown || selectedCounty">
          ...
          <button type="button" class="ml-2 text-primary-600 hover:underline" @click="clearFilters">
            Clear filters
          </button>
            ...
            <template #footer>
              <div class="flex justify-center">
                <div v-if="user && isAdmin" class="controls">
                  ...
                  <UButton icon="i-heroicons-pencil-square" class="mr-1 text-xs" size="sm" color="primary" @click="openEditModal(venue, venue.id)" />
                  <UButton icon="i-heroicons-photo" class="mr-1 text-xs" size="sm" color="pink" @click="openPhotoUploadModal(venue, venue.id)" />
                  <UButton icon="i-heroicons-map-pin" class="mr-1 text-xs" size="sm" color="primary" @click="openMapModal(venue, venue.id)" />
